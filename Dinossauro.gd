...
var cactos = [preload("res://HidranteP.tscn"),
			  preload("res://ConeP.tscn"),
			  preload("res://ConeComHidranteP.tscn"),
			  preload("res://HidranteG.tscn"),
			  preload("res://ConeG.tscn"),
			  preload("res://ConeComHidranteG.tscn")]
